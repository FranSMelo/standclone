class VehicleTypesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to vehicle_types_path, status: :see_other, notice: "Vehicle type was successfully destroyed." }
  ...
  private
    ...
    def set_vehicle_type
      @vehicle_type = VehicleType.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def vehicle_type_params
      params.expect(vehicle_type: [ :name ])
    end
end
