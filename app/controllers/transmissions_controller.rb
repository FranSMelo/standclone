class TransmissionsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to transmissions_path, status: :see_other, notice: "Transmission was successfully destroyed." }
  ...
  private
    ...
    def set_transmission
      @transmission = Transmission.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def transmission_params
      params.expect(transmission: [ :name ])
    end
end
