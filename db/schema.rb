...
ActiveRecord::Schema[8.0].define(version: 2025_03_15_214755) do
  ...
  create_table "vehicles", force: :cascade do |t|
    ...
    t.index ["condition_id"], name: "index_vehicles_on_condition_id"
    t.index ["fuel_type_id"], name: "index_vehicles_on_fuel_type_id"
    t.index ["segment_id"], name: "index_vehicles_on_segment_id"
  ...
  add_foreign_key "vehicles", "conditions"
  add_foreign_key "vehicles", "fuel_types"
  add_foreign_key "vehicles", "segments"
  add_foreign_key "vehicles", "transmissions"
