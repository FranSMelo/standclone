...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference("Segment.count") do
      post segments_url, params: { segment: { code: @segment.code, description: @segment.description, name: @segment.name } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { code: @segment.code, description: @segment.description, name: @segment.name } }
